...
class ManagementPage extends StatefulWidget {
  ...
  const ManagementPage({required this.server});

  @override
  _ManagementPage createState() => new _ManagementPage();
}
      ...
      body: SafeArea(
        child: Column(
          children: <Widget>[
            SizedBox(height: 80),
            InkWell(
              onTapDown: (details) => _sendMessage("a"),
            ...
            SizedBox(height: 50),
            InkWell(
              onTapDown: (details) => _sendMessage("b"),
              onTapUp: (details) => _sendMessage("c"),
              child: Icon(
                Icons.download,
                color: Colors.green,
